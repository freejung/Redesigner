...
Ext.onReady(function() {
    MODx.load({ xtype: 'redesigner-page-home'});
});
 
Redesigner.page.Home = function(config) {
    config = config || {};
    Ext.applyIf(config,{
        components: [{
            xtype: 'redesigner-panel-home'
            ,renderTo: 'redesigner-panel-home-div'
        }]
    });
    Redesigner.page.Home.superclass.constructor.call(this,config);
};
Ext.extend(Redesigner.page.Home,MODx.Component);
Ext.reg('redesigner-page-home',Redesigner.page.Home);